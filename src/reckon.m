...
## -*- texinfo -*-
## @deftypefn {Function File} {[@var{lato}, @var{lono}] = } {reckon(@var{lat}, @var{lon}, @var{range}, @var{azi})}
## @deftypefnx {Function File} {[@var{lato}, @var{lono}] = } {reckon(@var{lat}, @var{lon}, @var{range}, @var{azi}, @var{units})}
##
